...
tema_tabela_livro <- function(data) {
  ...
  data |>
    ...
    tab_options(
      ...
      table.border.bottom.color = cor_bege,
      table.border.bottom.width = px(2),
      
      # Delimitadores do cabeçalho das colunas
      column_labels.border.top.color = cor_bege,
      column_labels.border.top.width = px(1.5),
      column_labels.border.bottom.color = cor_bege,
      ...
      table_body.border.bottom.color = cor_bege,
      table_body.border.bottom.width = px(1.5),
      table_body.hlines.color = cor_bege,
