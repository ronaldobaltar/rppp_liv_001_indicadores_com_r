...
\FunctionTok{source}\NormalTok{(}\StringTok{"iiscr\_ggplot\_gt\_themes.R"}\NormalTok{)}
...
\FunctionTok{ggplot}\NormalTok{(mtcars2, }\FunctionTok{aes}\NormalTok{(hp, mpg, }\AttributeTok{color =}\NormalTok{ am)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"MPG versus horsepower by transmition"}\NormalTok{,}
    \AttributeTok{caption =} \StringTok{"Fonte: MTcars package"}
\NormalTok{    )}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{modelo_files/figure-pdf/unnamed-chunk-3-1.png}}
