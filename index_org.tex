...
\setkomafont{caption}{\sffamily\color{textoescuro}}
\setcapindent{0em}
% Altera a cor e a fonte do rótulo ("Figura 1:", "Tabela 1:")
\setkomafont{captionlabel}{\sffamily\color{textoescuro}}
...
\NormalTok{mtcars[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{] }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{tab\_header}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"Desempenho de Veículos Selecionados"}\NormalTok{,}
...
\begin{table}
\caption*{
{\fontsize{20}{25}\selectfont  Desempenho de Veículos Selecionados\fontsize{12}{15}\selectfont } \\ 
{\fontsize{14}{17}\selectfont  Consumo, número de cilindros e deslocamento volumétrico\fontsize{12}{15}\selectfont }
} 
